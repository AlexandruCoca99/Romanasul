...
<section>
<p class="title"><?php echo _("Mission:")?></p>
<span>
...
<p>&nbsp;</p>
<p class="title"><?php echo _("Short history:")?></p>
<span>
...
<p>&nbsp;</p>
<p class="title"><?php echo _("Members:")?></p>
<span>
   <?php echo _("Students of the Technical University and other Universities of Cluj-Napoca: each year, more than 80 students participate in our activities. Dancers, singers and musicians. Conductors, choreographers, stage directors, referents, artistic counselors.")?></span>

<p>&nbsp;</p>
<p class="title"><?php echo _("Choreographers:")?></p>
    <span>
      <ul type="circle">
          <li>
          ...
          <li>
              5. Ing.Viorel Roman (1994-<?php echo _("now")?>)
          </li>
      </ul>
    </span>

<p>&nbsp;</p>
<p class="title"><?php echo _("Conductors:")?></p>
<span>1. Prof.Paul Stoica (1974 - 1975)<br/>
  ...
  13. Hatfaludi Alexandru (2013 - <?php echo _("now")?>)
</span>

<p>&nbsp;</p>
<p class="title"><?php echo _("Cultural Attaches:")?></p>
<span>1. Prof.Ioan Bârsan (1974 - 1981)<br/>
  2. Prof.Mîndru Alexandru (1981 - 2003)<br/>
  3. Prof.Victor Bercea (1982 - 1989; 2002 -<?php echo _("now")?>)<br/>
  4. Ing.Marius Moldovan (2004 -<?php echo _("now")?>)<br/>
  5. Anghel Mirela (2003 -<?php echo _("now")?>)</span>

<p>&nbsp;</p>
<p class="title"><?php echo _("Singers:")?></p>
<span>1. Mariana Chiorean<br/>
   2. Ioan Dragoş<br/>
   3. Ioan Fechete<br/>
  4. Ionuţ Fulea<br/>
  5. Marius Fulea<br/>
  ...
  22. Mirela Suciu<br/>
  23. Camelia Lupaş<br/>
  24. Claudiu Ciotleuş</p></span>
<p class="a"><?php echo _("THE STAR OF THE SINGER GROUP, AND ARTISTIC COUNSELOR OF THE")?> &quot;Românaşul&quot; : IONUŢ
    FULEA</p>

<p>&nbsp;</p>
<p class="title"><?php echo _("Collaborating singers:")?></p>
<span>
    1. Mia Dan<br/>
    2. Dumitru Sopon<br/>
    3. Maria Marcu<br/>
...
<p>&nbsp;</p>
<p class="title"><?php echo _("Collaborating musicians:")?></p>
...
<p>&nbsp;</p>
<p class="title"><?php echo _("Show hosts:")?></p>
